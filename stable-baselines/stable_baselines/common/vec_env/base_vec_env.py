...
class VecEnv(ABC):
    ...
    :param num_agents: (int or None) the number of agents. If None, normal single agent mode.
    """
    metadata = {
        'render.modes': ['human', 'rgb_array']
    }

    def __init__(self, num_envs, observation_space, action_space, num_agents):
...
class VecEnvWrapper(VecEnv):
    ...
    def __init__(self, venv, observation_space=None, action_space=None, num_agents=None):
        self.venv = venv
        VecEnv.__init__(self, num_envs=venv.num_envs, observation_space=observation_space or venv.observation_space,
                        action_space=action_space or venv.action_space, num_agents=num_agents or getattr(venv, 'num_agents'))
